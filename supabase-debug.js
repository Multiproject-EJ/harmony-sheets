...
const SQL_MUTATING_PATTERN =
  /\b(insert|update|delete|truncate|alter|drop|create|replace|merge|call|execute|grant|revoke|policy|security)\b/i;
...
function initialiseSqlSection() {
  ...
  if (initialSnippet) {
    ...
    appendLog("info", "SQL workspace initialised with presets.", {
      presets: SQL_SNIPPETS.length,
      activePreset: initialSnippet.id,

...
with upserted as (
    ...
    values
        ...
        (
            'budget-blueprint',
            'Budget Blueprint — Cashflow Planning System',
            'Map your money plan and track cash flow in minutes each week.',
            $$<p><strong>Budget Blueprint</strong> is a guided cash-flow planning system that pairs Google Sheets with an interactive sidebar dashboard. Capture spending quickly, see planned versus actual totals, and keep savings goals in view every time you review your money.</p>$$,
            29.00,
            'USD',
            '$29',
            true,
            ...
            'assets/imgBudgetPro1.webp',
            'Prototype dashboard layout for the Budget Blueprint experience.',
            null,
            null,
            'Google sheets products/Budget Blueprint/budget-blueprint.html',
            'Preview the Budget Blueprint',
            'Draft concept for internal review — not yet for sale.',
            null,
            null
        ),
        (
            'life-wheel-companion',
            'Life Wheel Companion — Vision & Habit Planner',
            'Guide weekly life-area reflections with a calm, offline-ready dashboard.',
            $$<p><strong>Life Wheel Companion</strong> guides your life-area rituals with a progressive web app you can load on any device. Map vision statements, set goals, and log habits with offline support that syncs when you're back online.</p>$$,
            39.00,
            'USD',
            '$39',
            true,
            'assets/lifewheel-hero.svg',
            'assets/lifewheel-hero.svg',
            'Preview of the Life Wheel Companion PWA experience.',
            null,
            null,
            'Google sheets products/demo/lifewheel.html',
            'Preview the Life Wheel Companion',
            'Draft concept for guided life wheel rituals — not yet for sale.',
            null,
            null
        ),
        (
...
join (values
    ...
    ('budget-blueprint', null, null),
    ('life-wheel-companion', null, $$Draft preview available for Harmony Sheets reviewers.$$),
...
with data(slug, life_area, position) as (
    values
        ...
        ('budget-blueprint', 'finances', 1),
        ('budget-blueprint', 'family', 2),
        ('budget-blueprint', 'career', 3),
        ('life-wheel-companion', 'career', 1),
        ('life-wheel-companion', 'health', 2),
        ('life-wheel-companion', 'family', 3),
        ('life-wheel-companion', 'spirituality', 4),
...
with data(slug, badge, position) as (
    values
        ...
        ('budget-blueprint', 'Best-seller pipeline pick', 1),
        ('budget-blueprint', 'Google Sheets + Web demo', 2),
        ('budget-blueprint', 'One-time purchase', 3),
        ('life-wheel-companion', 'PWA demo', 1),
        ('life-wheel-companion', 'Guided reflections', 2),
        ('life-wheel-companion', 'Offline ready', 3),
...
with data(slug, feature, position) as (
    values
        ...
        ('budget-blueprint', 'Monthly overview board with budget vs. actuals', 1),
        ('budget-blueprint', 'Auto-generated insights for spending, saving, and cash flow', 2),
        ('budget-blueprint', 'Quick-add transaction form synced to Sheets', 3),
        ('budget-blueprint', 'Sidebar dashboard for weekly money reviews', 4),
        ('life-wheel-companion', 'Weekly life wheel check-ins', 1),
        ('life-wheel-companion', 'Goal and habit tracking by life area', 2),
        ('life-wheel-companion', 'Vision planning canvas for each category', 3),
        ('life-wheel-companion', 'Offline-first progressive web app with sync', 4),
...
with data(slug, image_src, image_alt, position) as (
    values
        ...
        ('budget-blueprint', 'assets/imgBudgetPro1.webp', 'Budget Blueprint dashboard mockup in Google Sheets', 1),
        ('life-wheel-companion', 'assets/lifewheel-hero.svg', 'Life Wheel Companion dashboard with goals and habits.', 1),
...
with data(slug, included_item, position) as (
    values
        ...
        ('budget-blueprint', 'Budget Blueprint Google Sheet', 1),
        ('budget-blueprint', 'Apps Script automation for quick logging', 2),
        ('budget-blueprint', 'Sidebar dashboard HTML demo', 3),
        ('budget-blueprint', 'Draft launch copy and messaging', 4),
        ('life-wheel-companion', 'Life Wheel Companion web app (draft)', 1),
        ('life-wheel-companion', 'Reflection and goal setting templates', 2),
        ('life-wheel-companion', 'Habit logging dashboards', 3),
        ('life-wheel-companion', 'Product roadmap feedback channel', 4),
...
with data(slug, question, answer, position) as (
    values
        ...
        ('budget-blueprint', 'Is this product live?', $$Not yet — the Budget Blueprint is currently an internal draft for review.$$, 1),
        ('budget-blueprint', 'Can I test the dashboard?', $$Yes. Open the sidebar demo to explore the interactions without leaving your browser.$$, 2),
        ('budget-blueprint', 'Will it sync with bank feeds?', $$The draft focuses on guided manual reviews. Bank import research is on the roadmap.$$, 3),
        ('life-wheel-companion', 'Is the Life Wheel Companion available to customers yet?', $$Not yet. This draft is for internal review and testing while we finalize the launch.$$, 1),
        ('life-wheel-companion', 'Can I explore the interactive demo?', $$Yes. Launch the embedded PWA demo to explore the current experience in the browser.$$, 2),
        ('life-wheel-companion', 'Does it work offline?', $$The PWA caches data locally and syncs your updates once you reconnect.$$, 3),
...
with data(slug, title, description, position) as (
    values
        ...
        ('budget-blueprint', 'Plan with confidence', 'Compare planned spending to reality every week with guided prompts.', 1),
        ('budget-blueprint', 'Stay on top of cash flow', 'Dashboard callouts highlight overspending and savings progress automatically.', 2),
        ('budget-blueprint', 'Review faster together', 'Quick-add forms and menu actions make shared budget rituals easy.', 3),
        ('life-wheel-companion', 'See every life area clearly', 'Visualize vision, goals, and habits in one guided dashboard.', 1),
        ('life-wheel-companion', 'Stay accountable gently', 'Weekly reflections and habit logs keep progress visible without overwhelm.', 2),
        ('life-wheel-companion', 'Use it anywhere', 'Offline-ready PWA works on desktop, tablet, or phone and syncs when connected.', 3),
